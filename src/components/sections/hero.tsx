...
import { copy, getLocaleDirection, type Locale } from "@/lib/i18n";
...
export default function Hero({ locale = "fa" }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative z-10 mx-auto w-full max-w-[1440px] px-5 pb-24 pt-28 sm:px-6 sm:pb-32 lg:px-16",
          locale === "en" ? "text-right" : "text-center"
        )}
      >
        <div className="fade-in-up mx-auto max-w-[44rem]">
          {/* Eyebrow badge */}
          ...
          {/* Main headline */}
          <h1 className="mx-auto mb-5 max-w-3xl text-3xl font-black leading-[1.25] text-white drop-shadow-[0_8px_24px_rgb(0,0,0,0.28)] sm:mb-7 sm:text-4xl sm:leading-[1.2] md:text-5xl lg:text-6xl lg:leading-[1.16]">
            {t.titlePrefix}{" "}
          ...
          {/* Sub-headline */}
          <p className="mx-auto mb-8 max-w-2xl text-sm leading-8 text-white/80 sm:text-base md:mb-10 md:text-lg md:leading-9">
            {t.description}
          </p>
